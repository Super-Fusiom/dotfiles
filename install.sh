...
if [ "$USER" == 'root' ] ; then
    ...
    cd
    rm -rf yay
    yay -S btop polkit bspwm alacritty nvim polybar rofi sxhkd nautilus feh picom xorg-server dunst xorg-xinit nerd-fonts-fira-code ttf-font-awesome betterlockscreen flameshot firefox
